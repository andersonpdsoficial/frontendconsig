'use client'; // Adicionado para compatibilidade com o Next.js
...
import { getServidor } from '../../shared/services/apiService';
...
const MargemContratacao = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      setError((err as Error).message || 'Erro ao buscar informações.');
    }
  };
